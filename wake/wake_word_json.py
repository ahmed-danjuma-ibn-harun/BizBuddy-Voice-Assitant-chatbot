...
if __name__ == "__main__":
    ...
    parser.add_argument('--zero_label_dir', type=str, default='data/not_wake/', required=False,
                        help='directory of clips with zero labels')
    parser.add_argument('--one_label_dir', type=str, default='data/wake/', required=False,
                        help='directory of clips with one labels')
    parser.add_argument('--save_json_path', type=str, default='../wake', required=False,
