...
#def mfcc(sample_rate=8000, fft_size=400, n_mfcc=40, hop_length=160, n_mels=40):
 #   extract = torchaudio.transforms.MFCC(
 #        sample_rate=sample_rate, n_mfcc= n_mfcc, melkwargs ={
  #          "n_fft": fft_size, "n_mels": n_mels, "center": False},
  #      )
  #  return extract
