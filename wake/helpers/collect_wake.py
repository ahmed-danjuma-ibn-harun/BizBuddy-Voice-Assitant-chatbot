...
def interactive(args):
    ...
    try:
        while True:
            ...
            input('press enter to continue. the recoding will be {} seconds. press ctrl + c to exit'.format(args.seconds))
            # time.sleep(0.02)  # so the mic don't pick up clicking sound
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_path', type=str, default='../data/class_1/', required=False,
                        help='full path to save file. i.e. /to/path/sound.wav')
    parser.add_argument('--interactive_save_path', type=str, default='../data/class_1/', required=False,
