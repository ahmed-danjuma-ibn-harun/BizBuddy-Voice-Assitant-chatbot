...
def main(args):
    ...
    for file in ones:
        ...
        for i in range(args.copy_number):
            ...
            new_dst_file = os.path.join(dest_dir, str(i) + "__" + file)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--wakewords_dir', type=str, default='../data/class_1/', required=False,
                        help='directory of clips with wakewords')

    parser.add_argument('--copy_destination', type=str, default='../data/wake/', required=False,
                        help='directory of the destinations of the wakewords copies')

    parser.add_argument('--copy_number', type=int, default=300, required=False,
